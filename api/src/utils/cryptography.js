...
//*for Mysql must be an array without key, only values
// const userToSave = {
...
// const adminSavedInMongoDao = await adminMongoDao.saveNewAdmin(userToSave);
// console.log({adminSavedInMongoDao});
